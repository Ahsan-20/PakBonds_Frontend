...
import { ChevronRight, Activity, Zap, BookOpen } from 'lucide-react';
        ...
        <section className="py-24 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
                    <div>
                        <h2 className="text-3xl font-bold text-white mb-3">Latest Insights</h2>
                        <p className="text-zinc-500">Expert guides and analysis for the modern investor.</p>
                    </div>
                    <Link to="/blog" className="flex items-center text-cyan-400 hover:text-cyan-300 transition-colors group">
                        View All Articles <ChevronRight size={20} className="group-hover:translate-x-1 transition-transform" />
                    </Link>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <Link to="/blog/winning-odds" className="group relative rounded-3xl overflow-hidden aspect-video bg-zinc-900 border border-white/10 block">
                        ...
                        <div className="absolute inset-0 p-8 flex flex-col justify-end z-10 transition-transform duration-500 group-hover:-translate-y-2">
                            ...
                            <p className="text-zinc-400">Statistical analysis of every denomination for 2026.</p>
                        </div>
                    </Link>

                    <Link to="/blog/automation-guide" className="group relative rounded-3xl overflow-hidden aspect-video bg-zinc-900 border border-white/10 block">
