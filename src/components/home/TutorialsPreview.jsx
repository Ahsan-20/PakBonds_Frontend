        ...
        <section className="py-24 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
                    ...
                    <Link to="/tutorials" className="flex items-center text-cyan-400 hover:text-cyan-300 transition-colors group">
                        View All Guides <ChevronRight size={20} className="group-hover:translate-x-1 transition-transform" />
                    </Link>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <Link to="/tutorials/winning-odds" className="group relative rounded-3xl overflow-hidden aspect-video bg-zinc-900 border border-white/10 block">
                    ...
                    <Link to="/tutorials/automation-guide" className="group relative rounded-3xl overflow-hidden aspect-video bg-zinc-900 border border-white/10 block">
