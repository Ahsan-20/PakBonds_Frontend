...
const ResetPassword = () => {
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] bg-purple-600/10 rounded-full blur-[120px] pointer-events-none -z-10" />
            <div className="absolute bottom-[-20%] left-[-10%] w-[600px] h-[600px] bg-cyan-600/10 rounded-full blur-[120px] pointer-events-none -z-10" />
            ...
            <div className="max-w-md w-full relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-white tracking-tight mb-2">New <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500">Credentials</span></h1>
                    <p className="text-zinc-500 text-sm">Create a new secure access key.</p>
                </div>
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••"
                                    className={`w-full pl-11 pr-11 py-3.5 bg-black/50 border rounded-xl text-white placeholder-zinc-600 focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/50 transition-all font-mono tracking-wider ${errors.newPassword ? 'border-red-500/50 focus:border-red-500' : 'border-white/10'
                                        }`}
                                />
                                <button
                                    type="button"
                            ...
                            {errors.newPassword && (
                                <p className="text-xs text-red-400 mt-2 flex items-center gap-1">
                                    <span className="w-1 h-1 rounded-full bg-red-400 mr-1" /> {errors.newPassword}
                                </p>
                            )}
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    placeholder="••••••••"
                                    className={`w-full pl-11 pr-11 py-3.5 bg-black/50 border rounded-xl text-white placeholder-zinc-600 focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50 transition-all font-mono tracking-wider ${errors.confirmPassword ? 'border-red-500/50 focus:border-red-500' : 'border-white/10'
                                        }`}
                                />
                                <button
                                    type="button"
                            ...
                            {errors.confirmPassword && (
                                <p className="text-xs text-red-400 mt-2 flex items-center gap-1">
                                    <span className="w-1 h-1 rounded-full bg-red-400 mr-1" /> {errors.confirmPassword}
                                </p>
                            )}
