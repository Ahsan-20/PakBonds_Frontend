...
const Compare = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 pt-28 pb-12">
            <Helmet>
                <title>Check Prize Bond Results | Instant Online Search</title>
                <meta name="description" content="Search your Pakistani Prize Bond numbers instantly against official 2026 draw records. Free service for checking 100, 200, 750, 1500, 25000, and 40000 denominations." />
                <meta name="keywords" content="check prize bond number, prize bond search engine, 1500 prize bond list, 2024 bond results, national savings search" />
            </Helmet>
            {/* Header */}
            <div className="mb-12">
