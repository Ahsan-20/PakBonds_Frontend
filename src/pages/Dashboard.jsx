...
const CommandCard = ({ title, subtitle, icon: Icon, to, gradient }) => (
    <Link to={to} className="group relative overflow-hidden rounded-2xl border border-white/10 hover:border-white/20 transition-all duration-300 h-32 flex flex-col justify-between p-6 bg-white/[0.02] hover:bg-white/[0.04]">
                        ...
                        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-900/20 to-black border border-white/10 p-8 h-full flex flex-col justify-center group">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="mt-6 flex items-center gap-2">
                                    ...
                                    <Link to="/download" className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-zinc-400 hover:text-white text-xs font-mono transition-colors flex items-center gap-1">
                                        <Download size={12} />
