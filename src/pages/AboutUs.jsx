...
const AboutUs = () => {
    return (
        <div className="min-h-screen bg-[#050505] text-white pt-28 pb-20 overflow-hidden">
            <Helmet>
                <title>About Us | PakBonds</title>
                <meta name="description" content="Learn about PakBonds, the leading automated Prize Bond checking platform in Pakistan. Our mission is to make tracking and winning effortless." />
                ...
                <meta property="og:description" content="Learn about the leading automated Prize Bond checking platform in Pakistan." />
                ...
                <meta name="twitter:description" content="Learn about the leading automated Prize Bond checking platform in Pakistan." />
            ...
            <div className="relative max-w-7xl mx-auto px-6 lg:px-8 mb-24">
                ...
                <div className="max-w-3xl">
                    ...
                    <div className="flex gap-4">
                        <Link to="/signup" className="px-8 py-4 bg-cyan-500 hover:bg-cyan-400 text-black font-bold rounded-xl transition-all shadow-[0_0_20px_rgba(6,182,212,0.3)] hover:shadow-[0_0_30px_rgba(6,182,212,0.5)]">
                            Join Us Free
                        </Link>
                    </div>
                </div>
