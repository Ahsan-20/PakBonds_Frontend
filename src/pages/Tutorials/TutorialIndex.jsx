...
const TutorialIndex = () => {
    ...
    return (
        <div className="min-h-screen pt-32 pb-20">
            <Helmet>
                <title>Prize Bond Tutorials & Guides | Learn How to Win</title>
                <meta name="description" content="Master prize bond investment with our comprehensive guides. Learn how to check bonds, understand winning odds, and automate your portfolio." />
            </Helmet>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-20 p-8 rounded-3xl bg-gradient-to-r from-cyan-900/20 to-blue-900/20 border border-cyan-500/20 text-center">
                    ...
                    <Link to="/signup" className="inline-flex items-center px-8 py-3 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-black font-bold transition-colors">
                        Get Started Free
                    </Link>
                </div>
            </div>
