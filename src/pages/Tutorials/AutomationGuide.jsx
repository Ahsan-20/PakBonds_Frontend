...
const AutomationGuide = () => (
    <div className="min-h-screen pt-32 pb-20">
        <Helmet>
            <title>Automate Prize Bond Checking | Alerts & Monitoring</title>
            <meta name="description" content="Set up automatic prize bond checking. Never check a list manually again. Get email and WhatsApp alerts for your winning bonds." />
        </Helmet>
